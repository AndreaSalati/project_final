...
data_0, data, n_c, dm, sample_id = get_data_from_anndata(cfg.path, cfg.genes)
...
x_, a0_, a1_, disp, losses = training(
    DATA, x_unif, coef_pau, n_c, dm, clamp, cfg.n_iter, cfg.batch_size, cfg.dev
)


plt.scatter(x_, x_unif[:], s=1)
plt.show()
